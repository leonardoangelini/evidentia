...
const ENTRIES = {
  ...
  chart: { label: 'Parole per versione nel tempo', kind: 'derivato', meaning: 'Ogni punto è una versione leggibile (parole sul verticale, tempo sull\'orizzontale). Le bande azzurre sono le sessioni, le linee rosse i grandi inserimenti, i cerchi viola le revisioni, il tratteggio gli intervalli lunghi, i trattini grigi sull\'asse le versioni non leggibili, che non hanno un conteggio di parole.', method: 'Fermando il mouse su una versione compaiono la sua data, le parole, la variazione rispetto alla precedente, il tipo di cambiamento, l\'intervallo, la sessione e l\'autore: gli stessi valori della scheda Versioni.', use: 'La linea congiunge solo le versioni leggibili: fra due punti non è osservato nulla.' },
